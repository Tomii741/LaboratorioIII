<?php
    ...
    if(isset($_POST['pagina'])){
        ...
        switch($_POST["category"]){
            ...
            break;    
            case "nacionales":
                $query = "SELECT * FROM tb_noticias WHERE CATEGORIA='1' LIMIT 6 OFFSET $empezando";  
            break;    
            case "internacionales":
                $query = "SELECT * FROM tb_noticias WHERE CATEGORIA='2' LIMIT 6 OFFSET $empezando";  
            break;    
            case "coronavirus":
                $query = "SELECT * FROM tb_noticias WHERE CATEGORIA='3' LIMIT 6 OFFSET $empezando";  
            break;    
        }
    }
